...
public class BOBJModelAnimator
{
    ...
    public static void animate(BOBJModel model, Animation animation, float frame, float blend, boolean skipInitial, boolean raw)
    {
        for (BOBJBone orderedBone : model.getArmature().orderedBones)
        {
            animateGroup(orderedBone, animation, frame, blend, skipInitial, raw);
        }
    }
    ...
    private static void animateGroup(BOBJBone group, Animation animation, float frame, float blend, boolean skipInitial, boolean raw)
    {
    ...
    private static void applyGroupAnimation(BOBJBone group, AnimationPart animation, float frame, float blend, boolean raw)
    {
